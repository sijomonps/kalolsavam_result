...
import { deadCodeElimination, extractModuleInfoFromAst, findReferencedIdentifiers, generateFromAst, parseAst } from "@tanstack/router-utils";
...
var StartCompiler = class {
	...
	*/
	...
	runAstTransforms({ ast, code, id, transforms }) {
		let modified = false;
